...
static void test_simple_path(void) {
    ...
    ASSERT(backtrack_run(&m, &backpack, BACKTRACK_FIRST) == 1, "returns 1");
...
static void test_no_solution(void) {
    ...
    Maze m = make_maze("#####"
                       ...
                       "#####", 5, 3);
    LinkedList backpack; list_init(&backpack);
    ASSERT(backtrack_run(&m, &backpack, BACKTRACK_FIRST) == 0, "returns 0");
...
static void test_best_finds_exit(void) {
    ...
    Maze m = make_maze("#####"
                       ...
                       "#####", 5, 3);
    LinkedList backpack; list_init(&backpack);
    ASSERT(backtrack_run(&m, &backpack, BACKTRACK_BEST) == 1, "returns 1");
    ASSERT(backpack.size == 1, "backpack has 1 treasure");
    list_free(&backpack);
}
...
static void test_best_no_solution(void) {
    ...
    Maze m = make_maze("#####"
                       ...
                       "#####", 5, 3);
    LinkedList backpack; list_init(&backpack);
    ASSERT(backtrack_run(&m, &backpack, BACKTRACK_BEST) == 0, "returns 0");
    list_free(&backpack);
}
...
static void test_best_picks_richer_path(void) {
    ...
    Maze m = make_maze("#######"
                       ...
                       "#######", 7, 5);
    LinkedList backpack; list_init(&backpack);
    int found = backtrack_run(&m, &backpack, BACKTRACK_BEST);
